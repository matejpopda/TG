...
% Vezměme $i$-regulární graf $G$ o $n$ vrcholech ($i<n$).
% Z handshaking lemmatu pak dostaneme, že $2|E| = in$. Odeberme z něj $h$ hran a máme 
...
% Z toho máme, 
% \begin{equation*}
%     \frac{|E|}{|V|} = \frac{i}{2} - \frac{h}{n}
% \end{equation*}

% $i$ zvolme tak, aby platilo $i = 2d$. 

% $n$ můžeme zvolit libovolně velké a proto tedy existuje $n$ tak, že člen $\frac{h}{n} < \varepsilon$ pro libovolné $\varepsilon$.
